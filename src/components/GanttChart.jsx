...
const GanttChart = () => {
    ...
    useEffect(() => {
        ...
        svg.selectAll("*").remove(); // SVG'yi temizle
        ...
        function drawChart() {
            ...
            months.forEach((month) => {
                ...
                g
                    ...
                    .attr("height", 20)
                    .attr("fill", "#ffffff") // Arka plan rengini ayarla
                    .attr("stroke", "black"); // Opsiyonel: Kenarlık ekleyebilirsiniz
        ...
        // Bugünün tarihi için dikey çizgi   // Bugünün tarihi için dikey çizgi
